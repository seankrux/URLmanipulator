...
// Event Handlers
function bindEvents() {
  document.getElementById('viewInput')?.addEventListener('click', () => onTabChange('input'));
  document.getElementById('viewCid')?.addEventListener('click', () => onTabChange('cid'));
...
function onTabChange(view) {
  state.view = view;
  document.getElementById('viewInput')?.classList.toggle('active', view === 'input');
  document.getElementById('viewCid')?.classList.toggle('active', view === 'cid');
  renderAll();
}
...
function updateKeywordCount() {
  ...
  out.textContent = `URLs to generate: ${lines.length}`;
}
